...
new_questions = [
   (1, "Why are you here today?", 1, "Why are you here today?", 
     ...
     "9/10"),
    (2, "How do you feel?", 2, "Can you describe your symptoms?", 
 "Too vague; should specify if asking about current symptoms or overall well-being.",
 "5/10"),

    (3, "When did you feel that?", 3, "When did the symptoms start?", 
 "Ambiguous; should clarify what 'that' refers to (e.g., symptoms).",
 "3/10"),
    (4, "Are the symptoms consistent?", 4, "Are the symptoms constant or do they come and go?", 
 "Clear and relevant; addresses the stability of symptoms effectively.",
 "7/10"),
    (5, "How severe is your discomfort on a scale of 1-10?", 5, "On a scale of 1 to 10, how severe is the pain/discomfort?", 
     ...
     "9/10"),
    (6, "What makes the symptoms better or worse?", 6, "Have you noticed anything that makes the symptoms better or worse?", 
 "Good, but could specify 'symptoms' for clarity.",
 "7/10"),
    (7, "Do you have any ongoing health issues?", 7, "Do you have any pre-existing medical conditions?", 
